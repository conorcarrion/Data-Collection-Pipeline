...
class Scraper:
    ...
    def __init__(self, mainpage_url, headless: bool):
        ...
        mainpage_breadcrumb_item_elements = self.driver.find_elements(
            By.XPATH, '//*[@class="breadcrumb__link"]'
        )
    ...
    def get_url_list(self, mainpage_url) -> list:
        ...
        total_product_cards = self.driver.find_element(
            By.XPATH, '//*[@class="paging-count__value js-paging-count__value--total"]'
        )
        ...
        pagesize = self.driver.find_element(
            By.XPATH, '//*[@class="paging-count__value js-paging-count__value--end"]'
        )
        ...
        print(
            f"the total number of spirits at this url is {total_product_cards_number} over {number_of_pages} pages."
        )
    ...
    def get_a_spirit_profile(self, url, spirit):
        ...
        spirit_name_element = self.driver.find_element(
            By.XPATH, '//*[@class="product-main__name"]'
        )
        spirit.name = spirit_name_element.get_attribute("innerText").split("\n")[0]
        try:
            spirit.subname = self.driver.find_element(
                By.XPATH, '//*[@class="product-main__sub-name"]'
            ).text
        ...
        main_data = self.driver.find_element(
            By.XPATH, '//*[@class="product-main__data"]'
        ).text
        ...
        price = self.driver.find_element(
            By.XPATH, '//*[@class="product-action__price"]'
        ).text
        spirit.price = float(
            price[1:].replace(",", "")
        )  # cut off the £ sign and remove comma

        spirit.description = self.driver.find_element(
            By.XPATH, '//*[@class="product-main__description"]'
        ).text
        ...
        for fact in facts:
            ...
            fact_key_element = fact.find_element(
                By.XPATH, './*[@class="product-facts__type"]'
            )
            fact_key = fact_key_element.get_attribute("innerText")
            fact_value_element = fact.find_element(
                By.XPATH, './p[@class="product-facts__data"]'
            )
        ...
        flavour_profile_style = self.driver.find_elements(
            By.XPATH,
        ...
        for flavour in flavour_profile_style:
            ...
            flavour_style_value = flavour.find_element(
                By.XPATH, './/span[@class="circle-text-content"]'
            ).text
            flavour_style_key = flavour.find_element(
                By.XPATH, './/span[@class="flavour-profile__label"]'
            ).text
        ...
        flavour_profile_character = self.driver.find_elements(
            By.XPATH,
        ...
        for flavour in flavour_profile_character:
            ...
            flavour_character = flavour.find_element(
                By.XPATH, './span[@class="flavour-profile__label"]'
            ).text
            spirit.flavour_character.append(flavour_character)

        try:
            spirit_image_element = self.driver.find_element(
                By.XPATH, '//*[@class="product-main__image"]'
            )
            ...
            spirit_image_elements = self.driver.find_elements(
                By.XPATH, '//*[@class="product-slider__image"]'
            )
        ...
        breadcrumb_item_elements = self.driver.find_elements(
            By.XPATH, '//*[@class="breadcrumb__link"]'
        )
        ...
        for element in breadcrumb_item_elements:
            ...
            if (
                element == breadcrumb_item_elements[-2]
            ):  # best way to scrape the brand name is from this element
